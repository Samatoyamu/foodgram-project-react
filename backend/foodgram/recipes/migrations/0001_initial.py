...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Уникальное название, не более 200 символов', max_length=200, validators=[recipes.validators.ValidateName()], verbose_name='Название ингредиента')),
                ('measurement_unit', models.CharField(help_text='Единица измерения, не более 200 символов', max_length=200, verbose_name='Единица измерения')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Название тега, не более 200 символов', max_length=200, unique=True, validators=[recipes.validators.ValidateName()], verbose_name='Название тега')),
                ('color', models.CharField(help_text='Поле HEX, не более 7 символов', max_length=7, unique=True, validators=[recipes.validators.ValidateHex()], verbose_name='Цвет(HEX)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipes_cart', to='recipes.recipes', verbose_name='Рецепт')),
            ],
            options={
